...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterS50;
...
@XmlType(name = "S50", propOrder = {"value"})
public class S50 extends AMetadata<S50> implements Comparable<S50> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterS50.class)
  protected String value;

  /**
   * Construct a new, empty S50 instance.
   */
  public S50() {
  }

  /**
   * Construct a new S50 instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public S50(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((S50) obj).getValue());
  }

...
/**
 * The SSRF S20 data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/30/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "S20", propOrder = {"value"})
public class S20 extends AMetadata<S20> implements Comparable<S20> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterS20.class)
  protected String value;

  /**
   * Construct a new, empty S20 instance.
   */
  public S20() {
  }

  /**
   * Construct a new S20 instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public S20(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((S20) obj).getValue());
  }

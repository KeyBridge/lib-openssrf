...
/**
 * The SSRF S40 data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/30/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "S40", propOrder = {"value"})
public class S40 extends AMetadata<S40> implements Comparable<S40> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterS40.class)
  protected String value;

  /**
   * Construct a new, empty S40 instance.
   */
  public S40() {
  }

  /**
   * Construct a new S40 instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public S40(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((S40) obj).getValue());
  }

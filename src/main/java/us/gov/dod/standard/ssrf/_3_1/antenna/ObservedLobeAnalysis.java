...
/**
In Data Item BeamType (US), indicate the pattern beam type that best represents the general shape of the beam as it radiates from the antenna. The beam shape is a direct function of the radiating antenna shape and the beams are characterized by their shape (volume) in space so as to help determine how and where to measure mainbeam and sidelobe levels. Additionally. radar beam shapes are generally characteristic of the function of a particular radar.
@since 3.1.0
*/
...
/**
In Data Item LobeSymmetric (US), indicate whether the sidelobe is symmetric.
@since 3.1.0
*/
...
/**
Get In Data Item BeamType (US), indicate the pattern beam type that best represents the general shape of the beam as it radiates from the antenna. The beam shape is a direct function of the radiating antenna shape and the beams are characterized by their shape (volume) in space so as to help determine how and where to measure mainbeam and sidelobe levels. Additionally. radar beam shapes are generally characteristic of the function of a particular radar.
...
/**
Set In Data Item BeamType (US), indicate the pattern beam type that best represents the general shape of the beam as it radiates from the antenna. The beam shape is a direct function of the radiating antenna shape and the beams are characterized by their shape (volume) in space so as to help determine how and where to measure mainbeam and sidelobe levels. Additionally. radar beam shapes are generally characteristic of the function of a particular radar.
...
@return the LobeID value in a {@link TS10} data type
@since 3.1.0
*/
...
@param value the LobeID value in a {@link TS10} data type
@since 3.1.0
*/
...
*/
    public boolean isSetLobeID() {
        return (this.lobeID!= null);
    }

/**
Get a name for the Antenna lobe. Examples: 1st Backlobe, 5th SideLobe, etc.

@return the LobeName value in a {@link TS25} data type
@since 3.1.0
*/
...
@param value the LobeName value in a {@link TS25} data type
@since 3.1.0
*/
...
*/
    public boolean isSetLobeName() {
        return (this.lobeName!= null);
    }

/**
Get In Data Item LobeSymmetric (US), indicate whether the sidelobe is symmetric.
...
/**
Set In Data Item LobeSymmetric (US), indicate whether the sidelobe is symmetric.
...
*/
    public Set<ObservedLobeValues> getObservedLobeValues() {
        if (observedLobeValues == null) {
            observedLobeValues = new HashSet<ObservedLobeValues>();
        }
...
@since 3.1.0
*/
    public ObservedLobeAnalysis withLobeID(TS10 value) {
        return this;
    }
...
*/
    public ObservedLobeAnalysis withObservedLobeValues(ObservedLobeValues... values) {
        if (values!= null) {
            for (ObservedLobeValues value: values) {
                getObservedLobeValues().add(value);
            }
        }
        return this;
    }
...
/**
 Get a string representation of this ObservedLobeAnalysis instance configuration.

...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterS22;
import us.gov.dod.standard.ssrf._3_1.metadata.AMetadata;

/**
 * The SSRF S22 data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/28/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "S22", propOrder = {"value"})
public class S22 extends AMetadata<S22> implements Comparable<S22> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterS22.class)
  protected String value;

  /**
   * Construct a new, empty S22 instance.
   */
  public S22() {
  }

  /**
   * Construct a new S22 instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public S22(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((S22) obj).getValue());
  }

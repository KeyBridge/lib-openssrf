...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterS2;
import us.gov.dod.standard.ssrf._3_1.metadata.AMetadata;

/**
 * The SSRF S2 data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/30/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "S2", propOrder = {"value"})
public class S2 extends AMetadata<S2> implements Comparable<S2> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterS2.class)
  protected String value;

  /**
   * Construct a new, empty S2 instance.
   */
  public S2() {
  }

  /**
   * Construct a new S2 instance with the given initial value.
   * <p>
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((S2) obj).getValue());
  }

...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterUS5;
import us.gov.dod.standard.ssrf._3_1.metadata.AMetadata;

/**
 * The SSRF US5 data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/28/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "US5", propOrder = {"value"})
public class US5 extends AMetadata<US5> implements Comparable<US5> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterUS5.class)
  protected String value;

  /**
   * Construct a new, empty US5 instance.
   */
  public US5() {
  }

  /**
   * Construct a new US5 instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public US5(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((US5) obj).getValue());
  }

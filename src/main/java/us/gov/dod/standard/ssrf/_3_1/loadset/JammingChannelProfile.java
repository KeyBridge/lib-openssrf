...
The signal level required to activate the loadset, for systems capable of selecting multiple power thresholds by sub-band or other region of interest.
...
The minimum time required to trigger the jammer after start of signal reception.
...
The frequency range dwell time; how long a sweep pauses on a particular frequency before moving to next technique.
...
The form of the Fast Fourier Transform used (e.g., Integral, Serial, Discrete).
...
The time interval for the recording of received signals, in (0-999) hours, (0-59) minutes, and (0-999,999,999) nanoseconds (hhh.mm.sssssssss). Example: one microsecond is entered as 1,000 nanoseconds (000.00.000001000).
...
The amount of time that the equipment will monitor the spectrum before initiating an action, in (0-999) hours, (0-59) minutes, and (0-999,999,999) nanoseconds (hhh.mm.sssssssss). Example: one microsecond is entered as 1,000 nanoseconds (000.00.000001000).
...
How many ramp techniques occur during the programmed frequency range dwell time.
...
The amount of time that the equipment will emit a jamming signal, in in (0-999) hours, (0-59) minutes, and (0-999,999,999) nanoseconds (hhh.mm.sssssssss). Example: one microsecond is entered as 1,000 nanoseconds (000.00.000001000).
...
/**
Get the signal level required to activate the loadset, for systems capable of selecting multiple power thresholds by sub-band or other region of interest.

@return the ActivationPower value in a {@link TdBm} data type
@since 3.1.0
*/
...
/**
Set the signal level required to activate the loadset, for systems capable of selecting multiple power thresholds by sub-band or other region of interest.

@param value the ActivationPower value in a {@link TdBm} data type
@since 3.1.0
*/
...
*/
    public boolean isSetActivationPower() {
        return (this.activationPower!= null);
    }

/**
Get the minimum time required to trigger the jammer after start of signal reception.

@return the ActivationTime value in a {@link Tmicrosecs} data type
@since 3.1.0
*/
...
/**
Set the minimum time required to trigger the jammer after start of signal reception.

@param value the ActivationTime value in a {@link Tmicrosecs} data type
@since 3.1.0
*/
...
@return the CarrierWaveform value in a {@link TS100} data type
@since 3.1.0
*/
...
@param value the CarrierWaveform value in a {@link TS100} data type
@since 3.1.0
*/
...
*/
    public boolean isSetCarrierWaveform() {
        return (this.carrierWaveform!= null);
    }

/**
Get the middle frequency in the band.

@return the CenterFreq value in a {@link TFreqM} data type
@since 3.1.0
*/
...
@param value the CenterFreq value in a {@link TFreqM} data type
@since 3.1.0
*/
...
/**
Get the frequency range dwell time; how long a sweep pauses on a particular frequency before moving to next technique.

@return the Dwell value in a {@link Tmicrosecs} data type
@since 3.1.0
*/
...
/**
Set the frequency range dwell time; how long a sweep pauses on a particular frequency before moving to next technique.

@param value the Dwell value in a {@link Tmicrosecs} data type
@since 3.1.0
*/
...
/**
Get In Data Item ExBlankingOn (US), indicate if external blanking is enabled.
...
/**
Set In Data Item ExBlankingOn (US), indicate if external blanking is enabled.
...
/**
Get the form of the Fast Fourier Transform used (e.g., Integral, Serial, Discrete).

@return the FFTType value in a {@link TS20} data type
@since 3.1.0
*/
...
/**
Set the form of the Fast Fourier Transform used (e.g., Integral, Serial, Discrete).

@param value the FFTType value in a {@link TS20} data type
@since 3.1.0
*/
...
/**
Get the time interval for the recording of received signals, in (0-999) hours, (0-59) minutes, and (0-999,999,999) nanoseconds (hhh.mm.sssssssss). Example: one microsecond is entered as 1,000 nanoseconds (000.00.000001000).

@return the ObserveTime value in a {@link TUS_Duration} data type
@since 3.1.0
*/
...
/**
Set the time interval for the recording of received signals, in (0-999) hours, (0-59) minutes, and (0-999,999,999) nanoseconds (hhh.mm.sssssssss). Example: one microsecond is entered as 1,000 nanoseconds (000.00.000001000).

@param value the ObserveTime value in a {@link TUS_Duration} data type
@since 3.1.0
*/
...
*/
    public boolean isSetObserveTime() {
        return (this.observeTime!= null);
    }

/**
Get the frequency offset relative to the center frequency of the channel.

@return the OffsetFreq value in a {@link TFreqM} data type
@since 3.1.0
*/
...
@param value the OffsetFreq value in a {@link TFreqM} data type
@since 3.1.0
*/
...
*/
    public boolean isSetOffsetFreq() {
        return (this.offsetFreq!= null);
    }

/**
Get the amount of time that the equipment will monitor the spectrum before initiating an action, in (0-999) hours, (0-59) minutes, and (0-999,999,999) nanoseconds (hhh.mm.sssssssss). Example: one microsecond is entered as 1,000 nanoseconds (000.00.000001000).

@return the RxDuration value in a {@link TUS_Duration} data type
@since 3.1.0
*/
...
/**
Set the amount of time that the equipment will monitor the spectrum before initiating an action, in (0-999) hours, (0-59) minutes, and (0-999,999,999) nanoseconds (hhh.mm.sssssssss). Example: one microsecond is entered as 1,000 nanoseconds (000.00.000001000).

@param value the RxDuration value in a {@link TUS_Duration} data type
@since 3.1.0
*/
...
*/
    public boolean isSetRxDuration() {
        return (this.rxDuration!= null);
    }

/**
Get the waveform information modulated, or impressed, on the carrier.

@return the Signal value in a {@link TS100} data type
@since 3.1.0
*/
...
@param value the Signal value in a {@link TS100} data type
@since 3.1.0
*/
...
/**
Get how many ramp techniques occur during the programmed frequency range dwell time.

@return the Techniques value in a {@link TUN5} data type
@since 3.1.0
*/
...
/**
Set how many ramp techniques occur during the programmed frequency range dwell time.

@param value the Techniques value in a {@link TUN5} data type
@since 3.1.0
*/
...
*/
    public boolean isSetTechniques() {
        return (this.techniques!= null);
    }

/**
Get a short description of the threat name or threat type.

@return the Threat value in a {@link TS100} data type
@since 3.1.0
*/
...
@param value the Threat value in a {@link TS100} data type
@since 3.1.0
*/
...
/**
Get the amount of time that the equipment will emit a jamming signal, in in (0-999) hours, (0-59) minutes, and (0-999,999,999) nanoseconds (hhh.mm.sssssssss). Example: one microsecond is entered as 1,000 nanoseconds (000.00.000001000).

@return the TxDuration value in a {@link TUS_Duration} data type
@since 3.1.0
*/
...
/**
Set the amount of time that the equipment will emit a jamming signal, in in (0-999) hours, (0-59) minutes, and (0-999,999,999) nanoseconds (hhh.mm.sssssssss). Example: one microsecond is entered as 1,000 nanoseconds (000.00.000001000).

@param value the TxDuration value in a {@link TUS_Duration} data type
@since 3.1.0
*/
...
*/
    public Set<TimingDeconflictionProtocol> getTimingDeconflictionProtocol() {
        if (timingDeconflictionProtocol == null) {
            timingDeconflictionProtocol = new HashSet<TimingDeconflictionProtocol>();
        }
...
@since 3.1.0
*/
    public JammingChannelProfile withCarrierWaveform(TS100 value) {
        return this;
    }
...
@since 3.1.0
*/
    public JammingChannelProfile withFreqMin(TFreqM value) {
        return this;
    }
...
@since 3.1.0
*/
    public JammingChannelProfile withSignal(TS100 value) {
        return this;
    }
...
@param values  One or more instances of type {@link TimingDeconflictionProtocol...}
@return The current JammingChannelProfile object instance
@since 3.1.0
*/
    public JammingChannelProfile withTimingDeconflictionProtocol(TimingDeconflictionProtocol... values) {
        if (values!= null) {
            for (TimingDeconflictionProtocol value: values) {
                getTimingDeconflictionProtocol().add(value);
            }
        }
        return this;
    }
...
/**
 Get a string representation of this JammingChannelProfile instance configuration.
...
{@link JammingChannelProfile} requires {@link S100 CarrierWaveform}, {@link FreqM FreqMin}, {@link S100 Signal}.

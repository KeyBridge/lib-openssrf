...
The start azimuth angle for the blanked sector. Use "0" or "360" for true north.
...
The stop azimuth angle for the blanked sector. Use "0" or "360" for true north.
...
The start elevation angle for the blanked sector. Use "-90" for straight down and "90" for directly overhead.
...
The stop elevation angle for the blanked sector. Use "-90" for straight down and "90" for directly overhead.
...
/**
Get the start azimuth angle for the blanked sector. Use "0" or "360" for true north.

@return the AzStart value in a {@link TAz} data type
@since 3.1.0
*/
...
/**
Set the start azimuth angle for the blanked sector. Use "0" or "360" for true north.

@param value the AzStart value in a {@link TAz} data type
@since 3.1.0
*/
...
/**
Get the stop azimuth angle for the blanked sector. Use "0" or "360" for true north.

@return the AzStop value in a {@link TAz} data type
@since 3.1.0
*/
public Az getAzStop() {
        return azStop;
...
/**
Set the stop azimuth angle for the blanked sector. Use "0" or "360" for true north.

@param value the AzStop value in a {@link TAz} data type
@since 3.1.0
*/
...
/**
Get the start elevation angle for the blanked sector. Use "-90" for straight down and "90" for directly overhead.

@return the ElevStart value in a {@link TElev} data type
@since 3.1.0
*/
...
/**
Set the start elevation angle for the blanked sector. Use "-90" for straight down and "90" for directly overhead.

@param value the ElevStart value in a {@link TElev} data type
@since 3.1.0
*/
...
/**
Get the stop elevation angle for the blanked sector. Use "-90" for straight down and "90" for directly overhead.

@return the ElevStop value in a {@link TElev} data type
@since 3.1.0
*/
...
/**
Set the stop elevation angle for the blanked sector. Use "-90" for straight down and "90" for directly overhead.

@param value the ElevStop value in a {@link TElev} data type
@since 3.1.0
*/

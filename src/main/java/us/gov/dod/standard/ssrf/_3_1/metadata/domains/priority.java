...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterPRIORITY;
...
@XmlType(name = "priority", propOrder = {"value"})
public class priority extends AMetadata<priority> implements Comparable<priority> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterPRIORITY.class)
  protected String value;

  /**
   * Construct a new, empty priority instance.
   */
  public priority() {
  }

  /**
   * Construct a new priority instance with the given initial value.
   * <p>
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((priority) obj).getValue());
  }

...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterS18;
import us.gov.dod.standard.ssrf._3_1.metadata.AMetadata;

/**
 * The SSRF S18 data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/28/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "S18", propOrder = {"value"})
public class S18 extends AMetadata<S18> implements Comparable<S18> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterS18.class)
  protected String value;

  /**
   * Construct a new, empty S18 instance.
   */
  public S18() {
  }

  /**
   * Construct a new S18 instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public S18(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((S18) obj).getValue());
  }

...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterMONTHS;
import us.gov.dod.standard.ssrf._3_1.metadata.AMetadata;

/**
 * The SSRF Months data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/30/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "Months", propOrder = {"value"})
public class Months extends AMetadata<Months> implements Comparable<Months> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterMONTHS.class)
  protected String value;

  /**
   * Construct a new, empty Months instance.
   */
  public Months() {
  }

  /**
   * Construct a new Months instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public Months(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((Months) obj).getValue());
  }

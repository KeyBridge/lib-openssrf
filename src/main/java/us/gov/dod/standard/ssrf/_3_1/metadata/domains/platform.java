...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterPLATFORM;
import us.gov.dod.standard.ssrf._3_1.metadata.AMetadata;

/**
 * The SSRF platform data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/30/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "platform", propOrder = {"value"})
public class platform extends AMetadata<platform> implements Comparable<platform> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterPLATFORM.class)
  protected String value;

  /**
   * Construct a new, empty platform instance.
   */
  public platform() {
  }

  /**
   * Construct a new platform instance with the given initial value.
   * <p>
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((platform) obj).getValue());
  }

...
/**
 * The SSRF Releasability data type.
 * <p>
...
public class Releasability extends AMetadata<Releasability> {
   ...
   */
  @XmlValue
  protected Set<ListCCY> value;

  /**
   * Construct a new, empty Releasability instance.
   */
  public Releasability() {
  }

  /**
   * Construct a new Releasability instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public Releasability(Set<ListCCY> value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((Releasability) obj).getValue());
  }//</editor-fold>
}

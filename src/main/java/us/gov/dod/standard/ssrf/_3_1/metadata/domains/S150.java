...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterS150;
import us.gov.dod.standard.ssrf._3_1.metadata.AMetadata;

/**
 * The SSRF S150 data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/30/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "S150", propOrder = {"value"})
public class S150 extends AMetadata<S150> implements Comparable<S150> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterS150.class)
  protected String value;

  /**
   * Construct a new, empty S150 instance.
   */
  public S150() {
  }

  /**
   * Construct a new S150 instance with the given initial value.
   * <p>
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((S150) obj).getValue());
  }

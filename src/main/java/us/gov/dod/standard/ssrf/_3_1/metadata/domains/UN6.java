...
/**
 * The SSRF UN6 data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/30/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "UN6", propOrder = {"value"})
public class UN6 extends AMetadata<UN6> implements Comparable<UN6> {
  ...
  /**
   * Construct a new, empty UN6 instance.
   */
  public UN6() {
  }

  /**
   * Construct a new UN6 instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public UN6(BigInteger value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((UN6) obj).getValue());
  }

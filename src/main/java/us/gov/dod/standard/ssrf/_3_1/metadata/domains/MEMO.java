...
/**
 * The SSRF MEMO data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/28/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "MEMO", propOrder = {"value"})
public class MEMO extends AMetadata<MEMO> implements Comparable<MEMO> {
  ...
  /**
   * Construct a new, empty MEMO instance.
   */
  public MEMO() {
  }

  /**
   * Construct a new MEMO instance with the given initial value.
   * <p>
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((MEMO) obj).getValue());
  }

...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterS11;
import us.gov.dod.standard.ssrf._3_1.metadata.AMetadata;

/**
 * The SSRF S11 data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/28/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "S11", propOrder = {"value"})
public class S11 extends AMetadata<S11> implements Comparable<S11> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterS11.class)
  protected String value;

  /**
   * Construct a new, empty S11 instance.
   */
  public S11() {
  }

  /**
   * Construct a new S11 instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public S11(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((S11) obj).getValue());
  }

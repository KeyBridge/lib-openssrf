...
/**
 * The SSRF S10 data type.
 * <p>
 * @author Key Bridge LLC &lt;developer@keybridge.ch&gt;
 * @version 3.1.0, 03/30/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "S10", propOrder = {"value"})
public class S10 extends AMetadata<S10> implements Comparable<S10> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterS10.class)
  protected String value;

  /**
   * Construct a new, empty S10 instance.
   */
  public S10() {
  }

  /**
   * Construct a new S10 instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public S10(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((S10) obj).getValue());
  }

...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterDAYSOFWEEK;
import us.gov.dod.standard.ssrf._3_1.metadata.AMetadata;

/**
 * The SSRF DaysOfWeek data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/28/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "DaysOfWeek", propOrder = {"value"})
public class DaysOfWeek extends AMetadata<DaysOfWeek> implements Comparable<DaysOfWeek> {
   ...
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterDAYSOFWEEK.class)
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((DaysOfWeek) obj).getValue());
  }

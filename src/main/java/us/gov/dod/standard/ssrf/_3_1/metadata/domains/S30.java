...
/**
 * The SSRF S30 data type.
 * <p>
 * @author Key Bridge LLC &lt;developer@keybridge.ch&gt;
 * @version 3.1.0, 03/30/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "S30", propOrder = {"value"})
public class S30 extends AMetadata<S30> implements Comparable<S30> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterS30.class)
  protected String value;

  /**
   * Construct a new, empty S30 instance.
   */
  public S30() {
  }

  /**
   * Construct a new S30 instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public S30(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((S30) obj).getValue());
  }

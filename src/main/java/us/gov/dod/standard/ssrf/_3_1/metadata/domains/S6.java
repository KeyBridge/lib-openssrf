...
/**
 * The SSRF S6 data type.
 * <p>
 * @author Key Bridge LLC &lt;developer@keybridge.ch&gt;
 * @version 3.1.0, 03/30/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "S6", propOrder = {"value"})
public class S6 extends AMetadata<S6> implements Comparable<S6> {
  ...
  /**
   * Construct a new, empty S6 instance.
   */
  public S6() {
  }

  /**
   * Construct a new S6 instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public S6(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((S6) obj).getValue());
  }

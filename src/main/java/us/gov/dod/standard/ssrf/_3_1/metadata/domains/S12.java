...
/**
 * The SSRF S12 data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/30/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "S12", propOrder = {"value"})
public class S12 extends AMetadata<S12> implements Comparable<S12> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterS12.class)
  protected String value;

  /**
   * Construct a new, empty S12 instance.
   */
  public S12() {
  }

  /**
   * Construct a new S12 instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public S12(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((S12) obj).getValue());
  }

...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterYEARS;
import us.gov.dod.standard.ssrf._3_1.metadata.AMetadata;

/**
 * The SSRF Years data type.
 * <p>
 * @author Key Bridge LLC &lt;developer@keybridge.ch&gt;
 * @version 3.1.0, 03/30/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "Years", propOrder = {"value"})
public class Years extends AMetadata<Years> implements Comparable<Years> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterYEARS.class)
  protected String value;

  /**
   * Construct a new, empty Years instance.
   */
  public Years() {
  }

  /**
   * Construct a new Years instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public Years(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((Years) obj).getValue());
  }

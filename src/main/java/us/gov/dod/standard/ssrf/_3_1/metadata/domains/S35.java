...
/**
 * The SSRF S35 data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/28/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "S35", propOrder = {"value"})
public class S35 extends AMetadata<S35> implements Comparable<S35> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterS35.class)
  protected String value;

  /**
   * Construct a new, empty S35 instance.
   */
  public S35() {
  }

  /**
   * Construct a new S35 instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public S35(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((S35) obj).getValue());
  }

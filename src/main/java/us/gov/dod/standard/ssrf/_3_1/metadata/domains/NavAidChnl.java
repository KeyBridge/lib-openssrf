...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterNAVAIDCHNL;
import us.gov.dod.standard.ssrf._3_1.metadata.AMetadata;

/**
 * The SSRF NavAidChnl data type.
 * <p>
 * @author Key Bridge LLC &lt;developer@keybridge.ch&gt;
 * @version 3.1.0, 03/30/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "NavAidChnl", propOrder = {"value"})
public class NavAidChnl extends AMetadata<NavAidChnl> implements Comparable<NavAidChnl> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterNAVAIDCHNL.class)
  protected String value;

  /**
   * Construct a new, empty NavAidChnl instance.
   */
  public NavAidChnl() {
  }

  /**
   * Construct a new NavAidChnl instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public NavAidChnl(String value) {
    this.value = value;
  }
   ...
   */
  @Override
  public int compareTo(NavAidChnl obj) {
    if (obj == null) {
      return -1;
    }
    if (this.value == null) {

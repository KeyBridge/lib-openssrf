...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterHOURS;
import us.gov.dod.standard.ssrf._3_1.metadata.AMetadata;

/**
 * The SSRF Hours data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/30/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "Hours", propOrder = {"value"})
public class Hours extends AMetadata<Hours> implements Comparable<Hours> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterHOURS.class)
  protected String value;

  /**
   * Construct a new, empty Hours instance.
   */
  public Hours() {
  }

  /**
   * Construct a new Hours instance with the given initial value.
   * <p>
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((Hours) obj).getValue());
  }

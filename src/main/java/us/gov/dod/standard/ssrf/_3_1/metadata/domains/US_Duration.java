...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterUS_DURATION;
...
@XmlType(name = "US_Duration", propOrder = {"value"})
public class US_Duration extends AMetadata<US_Duration> implements Comparable<US_Duration> {
  ...
  /**
   * Construct a new, empty US_Duration instance.
   */
  public US_Duration() {
  }

  /**
   * Construct a new US_Duration instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public US_Duration(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((US_Duration) obj).getValue());
  }
   ...
   */
  @Override
  public int compareTo(US_Duration obj) {
    if (obj == null) {
      return -1;
    }
    if (this.value == null) {

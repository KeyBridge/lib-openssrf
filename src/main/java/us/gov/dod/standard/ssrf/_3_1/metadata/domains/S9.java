...
import us.gov.dod.standard.ssrf._3_1.adapter.types.XmlAdapterS9;
import us.gov.dod.standard.ssrf._3_1.metadata.AMetadata;

/**
 * The SSRF S9 data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/28/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "S9", propOrder = {"value"})
public class S9 extends AMetadata<S9> implements Comparable<S9> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterS9.class)
  protected String value;

  /**
   * Construct a new, empty S9 instance.
   */
  public S9() {
  }

  /**
   * Construct a new S9 instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public S9(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((S9) obj).getValue());
  }

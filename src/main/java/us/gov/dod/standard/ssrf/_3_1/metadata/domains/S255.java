...
/**
 * The SSRF S255 data type.
 * <p>
 * @author Key Bridge LLC <developer@keybridge.ch>
 * @version 3.1.0, 03/30/2015
 */
@XmlAccessorType(XmlAccessType.FIELD)
@XmlType(name = "S255", propOrder = {"value"})
public class S255 extends AMetadata<S255> implements Comparable<S255> {

  /**
   * The value property.
   */
  @XmlValue
  @XmlJavaTypeAdapter(XmlAdapterS255.class)
  protected String value;

  /**
   * Construct a new, empty S255 instance.
   */
  public S255() {
  }

  /**
   * Construct a new S255 instance with the given initial value.
   * <p>
   * @param value The initial value.
   */
  public S255(String value) {
    this.value = value;
  }
  ...
  public boolean equals(Object obj) {
    ...
    return Objects.equals(this.value, ((S255) obj).getValue());
  }

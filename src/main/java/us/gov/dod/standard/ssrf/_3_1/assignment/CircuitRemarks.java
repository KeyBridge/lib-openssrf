...
The Any additional data to be submitted by the applicant that cannot be accommodated in any of the other data items in the Government Master File (GMF).
...
/**
Get the Any additional data to be submitted by the applicant that cannot be accommodated in any of the other data items in the Government Master File (GMF).
...
/**
Set the Any additional data to be submitted by the applicant that cannot be accommodated in any of the other data items in the Government Master File (GMF).

@param values  One or more instances of type {@link BigInteger...}
@return The current CircuitRemarks object instance
@since 3.1.0
*/
    public CircuitRemarks withRemarks(BigInteger... values) {
        if (values!= null) {
...
@since 3.1.0
*/
    public CircuitRemarks withRemarks(Collection<BigInteger> values) {
        if (values!= null) {
...
@since 3.1.0
*/
    public CircuitRemarks withExtReferences(BigInteger... values) {
        if (values!= null) {
            for (BigInteger value: values) {
...
@since 3.1.0
*/
    public CircuitRemarks withExtReferences(Collection<BigInteger> values) {
        if (values!= null) {
...
{@link CircuitRemarks} requires {@link ListCCL cls}.

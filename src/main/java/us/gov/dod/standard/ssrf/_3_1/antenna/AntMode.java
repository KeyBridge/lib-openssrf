...
Sub-Elements are {@link AntEfficiency}, {@link AntFreqs}, {@link AntGain}, {@link AntPattern}, {@link ObservedLobeAnalysis}, {@link ObservedPolarisationAnalysis}, {@link ObservedScanAnalysis}, {@link VSWR}
...
A short name for the mode; this name should be a meaningful identification of the mode, but it can also be automatically generated in some systems. The Name MUST be unique within the dataset and SHOULD NOT be modified during the entire lifetime of the dataset.
...
/**
In Data Item ModeUse, indicate if the mode is used for transmit, receive, or both transmit and receive.
@since 3.1.0
*/
...
The principal orientation of the electric field of the electromagnetic wave for an antenna.
...
The angle of the electric field vector measured counter-clockwise from the equatorial plane as referenced from the boresight or typical static positioning of the antenna.
...
The number of degrees per second the antenna is capable of scanning. It is not necessarily the "Sector Scanned" figure times the degrees per second. If a significant portion of time is spent vertically scanning in between horizontal sweeps, the horizontal scan rate will be lower than if the antenna were horizontally scanning all the time.
...
The maximum horizontal sector the antenna can scan (enter 360 for a full rotation).
...
The number of degrees of vertical scan per second. If an antenna does a horizontal scan per second as part of a raster scan and drops down one degree after each sweep, it is scanning vertically at one degree per second. If the same antenna completed a scan in 30 seconds the vertical scan speed would be 2 degrees per minute.
...
The number of complete vertical scans per minute. If the antenna does a horizontal scan per second as part of a raster scan and drops down one degree after each sweep, it is scanning vertically at one degree per second. If the same antenna completed a scan in 30 seconds the vertical scan rate would be 2 scans per minute.
...
The maximum horizontal beamwidth for beamwidths which vary with the frequency.
...
The maximum vertical beamwidth for beamwidths which vary with the frequency.
...
The power ratio between the signal injected into one port and the power returned by the other port .
...
AntEfficiency describes the antenna efficiency at various frequencies within the frequency range of the antenna.
@since 3.1.0
*/
...
ObservedLobeAnalysis (US) contains general data associated with observed Antenna sidelobes and backlobes.
@since 3.1.0
*/
...
/**
Get a short name for the mode; this name should be a meaningful identification of the mode, but it can also be automatically generated in some systems. The Name MUST be unique within the dataset and SHOULD NOT be modified during the entire lifetime of the dataset.
...
/**
Set a short name for the mode; this name should be a meaningful identification of the mode, but it can also be automatically generated in some systems. The Name MUST be unique within the dataset and SHOULD NOT be modified during the entire lifetime of the dataset.
...
/**
Get In Data Item ModeUse, indicate if the mode is used for transmit, receive, or both transmit and receive.
...
/**
Set In Data Item ModeUse, indicate if the mode is used for transmit, receive, or both transmit and receive.
...
/**
Get the general category for the movement of a scanning or tracking antenna.
...
/**
Set the general category for the movement of a scanning or tracking antenna.
...
/**
Get the principal orientation of the electric field of the electromagnetic wave for an antenna.
...
/**
Set the principal orientation of the electric field of the electromagnetic wave for an antenna.
...
/**
Get the angle of the electric field vector measured counter-clockwise from the equatorial plane as referenced from the boresight or typical static positioning of the antenna.

@return the PolarisationAngle value in a {@link TAz} data type
@since 3.1.0
*/
...
/**
Set the angle of the electric field vector measured counter-clockwise from the equatorial plane as referenced from the boresight or typical static positioning of the antenna.

@param value the PolarisationAngle value in a {@link TAz} data type
@since 3.1.0
*/
...
/**
Get the number of degrees per second the antenna is capable of scanning. It is not necessarily the "Sector Scanned" figure times the degrees per second. If a significant portion of time is spent vertically scanning in between horizontal sweeps, the horizontal scan rate will be lower than if the antenna were horizontally scanning all the time.

@return the HorzScanSpeed value in a {@link TScanSpeed} data type
@since 3.1.0
*/
...
/**
Set the number of degrees per second the antenna is capable of scanning. It is not necessarily the "Sector Scanned" figure times the degrees per second. If a significant portion of time is spent vertically scanning in between horizontal sweeps, the horizontal scan rate will be lower than if the antenna were horizontally scanning all the time.

@param value the HorzScanSpeed value in a {@link TScanSpeed} data type
@since 3.1.0
*/
...
/**
Get the number of complete scans the antenna is capable of making each minute.

@return the HorzScanRate value in a {@link TScanRate} data type
@since 3.1.0
*/
...
/**
Set the number of complete scans the antenna is capable of making each minute.

@param value the HorzScanRate value in a {@link TScanRate} data type
@since 3.1.0
*/
...
/**
Get the maximum horizontal sector the antenna can scan (enter 360 for a full rotation).

@return the HorzScanSector value in a {@link TAz} data type
@since 3.1.0
*/
...
/**
Set the maximum horizontal sector the antenna can scan (enter 360 for a full rotation).

@param value the HorzScanSector value in a {@link TAz} data type
@since 3.1.0
*/
...
/**
Get the number of degrees of vertical scan per second. If an antenna does a horizontal scan per second as part of a raster scan and drops down one degree after each sweep, it is scanning vertically at one degree per second. If the same antenna completed a scan in 30 seconds the vertical scan speed would be 2 degrees per minute.

@return the VertScanSpeed value in a {@link TScanSpeed} data type
@since 3.1.0
*/
...
/**
Set the number of degrees of vertical scan per second. If an antenna does a horizontal scan per second as part of a raster scan and drops down one degree after each sweep, it is scanning vertically at one degree per second. If the same antenna completed a scan in 30 seconds the vertical scan speed would be 2 degrees per minute.

@param value the VertScanSpeed value in a {@link TScanSpeed} data type
@since 3.1.0
*/
...
/**
Get the number of complete vertical scans per minute. If the antenna does a horizontal scan per second as part of a raster scan and drops down one degree after each sweep, it is scanning vertically at one degree per second. If the same antenna completed a scan in 30 seconds the vertical scan rate would be 2 scans per minute.

@return the VertScanRate value in a {@link TScanRate} data type
@since 3.1.0
*/
...
/**
Set the number of complete vertical scans per minute. If the antenna does a horizontal scan per second as part of a raster scan and drops down one degree after each sweep, it is scanning vertically at one degree per second. If the same antenna completed a scan in 30 seconds the vertical scan rate would be 2 scans per minute.

@param value the VertScanRate value in a {@link TScanRate} data type
@since 3.1.0
*/
...
/**
Get the minimum limit of the vertical arc scanned relative to the horizontal.

@return the VertScanAngleMin value in a {@link TElev} data type
@since 3.1.0
*/
...
/**
Set the minimum limit of the vertical arc scanned relative to the horizontal.

@param value the VertScanAngleMin value in a {@link TElev} data type
@since 3.1.0
*/
...
/**
Get the maximum limit of the vertical arc scanned relative to the horizontal.

[XSL ERR MINMAX] If VertScanAngleMax is used, it MUST be greater than VertScanAngleMin.

@return the VertScanAngleMax value in a {@link TElev} data type
@since 3.1.0
*/
...
/**
Set the maximum limit of the vertical arc scanned relative to the horizontal.

[XSL ERR MINMAX] If VertScanAngleMax is used, it MUST be greater than VertScanAngleMin.

@param value the VertScanAngleMax value in a {@link TElev} data type
@since 3.1.0
*/
...
@return the RotationRateMin value in a {@link TRotationRate} data type
@since 3.1.0
*/
...
@param value the RotationRateMin value in a {@link TRotationRate} data type
@since 3.1.0
*/
...
@return the RotationRateMax value in a {@link TRotationRate} data type
@since 3.1.0
*/
...
@param value the RotationRateMax value in a {@link TRotationRate} data type
@since 3.1.0
*/
...
@return the HorzBwMin value in a {@link TAz} data type
@since 3.1.0
*/
...
@param value the HorzBwMin value in a {@link TAz} data type
@since 3.1.0
*/
...
/**
Get the maximum horizontal beamwidth for beamwidths which vary with the frequency.

[XSL ERR MINMAX] If HorzBwMax is used, it MUST be greater than HorzBwMin.

@return the HorzBwMax value in a {@link TAz} data type
@since 3.1.0
*/
...
/**
Set the maximum horizontal beamwidth for beamwidths which vary with the frequency.

[XSL ERR MINMAX] If HorzBwMax is used, it MUST be greater than HorzBwMin.

@param value the HorzBwMax value in a {@link TAz} data type
@since 3.1.0
*/
...
@return the VertBwMin value in a {@link TAz} data type
@since 3.1.0
*/
...
@param value the VertBwMin value in a {@link TAz} data type
@since 3.1.0
*/
...
/**
Get the maximum vertical beamwidth for beamwidths which vary with the frequency.

[XSL ERR MINMAX] If VertBwMax is used, it MUST be greater than VertBwMin.

@return the VertBwMax value in a {@link TAz} data type
@since 3.1.0
*/
...
/**
Set the maximum vertical beamwidth for beamwidths which vary with the frequency.

[XSL ERR MINMAX] If VertBwMax is used, it MUST be greater than VertBwMin.

@param value the VertBwMax value in a {@link TAz} data type
@since 3.1.0
*/
...
@return the MaxPower value in a {@link TdBW} data type
@since 3.1.0
*/
...
@param value the MaxPower value in a {@link TdBW} data type
@since 3.1.0
*/
...
/**
Get the power ratio between the signal injected into one port and the power returned by the other port .

@return the PortIsolation value in a {@link TdB} data type
@since 3.1.0
*/
...
/**
Set the power ratio between the signal injected into one port and the power returned by the other port .

@param value the PortIsolation value in a {@link TdB} data type
@since 3.1.0
*/
...
*/
    public Set<AntPattern> getAntPattern() {
        if (antPattern == null) {
            antPattern = new HashSet<AntPattern>();
        }
...
*/
    public Set<AntEfficiency> getAntEfficiency() {
        if (antEfficiency == null) {
            antEfficiency = new HashSet<AntEfficiency>();
        }
...
*/
    public Set<ObservedLobeAnalysis> getObservedLobeAnalysis() {
        if (observedLobeAnalysis == null) {
            observedLobeAnalysis = new HashSet<ObservedLobeAnalysis>();
        }
...
*/
    public Set<ObservedPolarisationAnalysis> getObservedPolarisationAnalysis() {
        if (observedPolarisationAnalysis == null) {
            observedPolarisationAnalysis = new HashSet<ObservedPolarisationAnalysis>();
        }
...
*/
    public Set<ObservedScanAnalysis> getObservedScanAnalysis() {
        if (observedScanAnalysis == null) {
            observedScanAnalysis = new HashSet<ObservedScanAnalysis>();
        }
...
@since 3.1.0
*/
    public AntMode withModeID(TS20 value) {
        return this;
    }
...
@param value  An instances of type {@link TRotationRate}
@return The current AntMode object instance
@since 3.1.0
*/
    public AntMode withRotationRateMin(TRotationRate value) {
        return this;
    }
...
*/
    public AntMode withAntGain(AntGain... values) {
        if (values!= null) {
            for (AntGain value: values) {
                getAntGain().add(value);
            }
        }
        return this;
    }
...
*/
    public AntMode withAntFreqs(AntFreqs... values) {
        if (values!= null) {
            for (AntFreqs value: values) {
                getAntFreqs().add(value);
            }
        }
        return this;
    }
...
*/
    public AntMode withAntPattern(AntPattern... values) {
        if (values!= null) {
            for (AntPattern value: values) {
                getAntPattern().add(value);
            }
        }
        return this;
    }
...
*/
    public AntMode withAntEfficiency(AntEfficiency... values) {
        if (values!= null) {
            for (AntEfficiency value: values) {
                getAntEfficiency().add(value);
            }
        }
        return this;
    }
...
*/
    public AntMode withObservedLobeAnalysis(ObservedLobeAnalysis... values) {
        if (values!= null) {
            for (ObservedLobeAnalysis value: values) {
                getObservedLobeAnalysis().add(value);
            }
        }
        return this;
    }
...
@param values  One or more instances of type {@link ObservedPolarisationAnalysis...}
@return The current AntMode object instance
@since 3.1.0
*/
    public AntMode withObservedPolarisationAnalysis(ObservedPolarisationAnalysis... values) {
        if (values!= null) {
            for (ObservedPolarisationAnalysis value: values) {
                getObservedPolarisationAnalysis().add(value);
            }
        }
        return this;
    }
...
@param values  A collection of {@link ObservedPolarisationAnalysis} instances
@return The current AntMode object instance
@since 3.1.0
*/
...
*/
    public AntMode withObservedScanAnalysis(ObservedScanAnalysis... values) {
        if (values!= null) {
            for (ObservedScanAnalysis value: values) {
                getObservedScanAnalysis().add(value);
            }
        }
        return this;
    }

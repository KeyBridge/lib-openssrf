...
public class AntMode {
  ...
  public String toString() {
    return "AntMode {"
           ...
           + (horzBwMax != null ? "\n horzBwMax [" + horzBwMax + "]" : "")
           + (horzBwMin != null ? "\n horzBwMin [" + horzBwMin + "]" : "")
           + (horzScanRate != null ? "\n horzScanRate [" + horzScanRate + "]" : "")
           + (horzScanSector != null ? "\n horzScanSector [" + horzScanSector + "]" : "")
           + (horzScanSpeed != null ? "\n horzScanSpeed [" + horzScanSpeed + "]" : "")
           + (horzScanType != null ? "\n horzScanType [" + horzScanType + "]" : "")
           + (maxPower != null ? "\n maxPower [" + maxPower + "]" : "")
           + (modeID != null ? "\n modeID [" + modeID + "]" : "")
           + (modeName != null ? "\n modeName [" + modeName + "]" : "")
           + (modeUse != null ? "\n modeUse [" + modeUse + "]" : "")
           + (motionType != null ? "\n motionType [" + motionType + "]" : "")
           + (observedLobeAnalysis != null ? "\n observedLobeAnalysis [" + observedLobeAnalysis + "]" : "")
           + (observedPolarisationAnalysis != null ? "\n observedPolarisationAnalysis [" + observedPolarisationAnalysis + "]" : "")
           + (observedScanAnalysis != null ? "\n observedScanAnalysis [" + observedScanAnalysis + "]" : "")
           + (polarisationAngle != null ? "\n polarisationAngle [" + polarisationAngle + "]" : "")
           + (polarisationType != null ? "\n polarisationType [" + polarisationType + "]" : "")
           + (portIsolation != null ? "\n portIsolation [" + portIsolation + "]" : "")
           + (rotationDirection != null ? "\n rotationDirection [" + rotationDirection + "]" : "")
           + (rotationRateMax != null ? "\n rotationRateMax [" + rotationRateMax + "]" : "")
           + (rotationRateMin != null ? "\n rotationRateMin [" + rotationRateMin + "]" : "")
           + (sectBlanking != null ? "\n sectBlanking [" + sectBlanking + "]" : "")
           + (vertBwMax != null ? "\n vertBwMax [" + vertBwMax + "]" : "")
           + (vertBwMin != null ? "\n vertBwMin [" + vertBwMin + "]" : "")
           + (vertScanAngleMax != null ? "\n vertScanAngleMax [" + vertScanAngleMax + "]" : "")
           + (vertScanAngleMin != null ? "\n vertScanAngleMin [" + vertScanAngleMin + "]" : "")
           + (vertScanRate != null ? "\n vertScanRate [" + vertScanRate + "]" : "")
           + (vertScanSpeed != null ? "\n vertScanSpeed [" + vertScanSpeed + "]" : "")
           + (vertScanType != null ? "\n vertScanType [" + vertScanType + "]" : "")
           + (vswr != null ? "\n vswr [" + vswr + "]" : "")
           + "}";
  }
